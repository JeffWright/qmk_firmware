...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_reviung41(
      ...
      KC_LSFT,KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,                KC_N,    KC_M,    KC_COMMA,KC_DOT,  KC_SLASH,   DEL_FNKEYS,
    ...
    [_SYM] = LAYOUT_reviung41(
      ...
      _______,    KC_AMPR, KC_ASTR, KC_TILDE,KC_DOLLAR,KC_PIPE,                    xxxxxxx,   xxxxxxx, _______, _______, KC_BSLS, xxxxxxx,
                                               _______, xxxxxxx,   _______, xxxxxxx,  xxxxxxx
    ),

    [_NAV] = LAYOUT_reviung41(
      xxxxxxx,         DM_PLY1, NAV_BACK,      xxxxxxx, NAV_FWD,       xxxxxxx,                           xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, TG_NIX,
      KC_ESC,          HRM_PNK,         HRM_RNG,       HRM_MID, HRM_IDX,       COS_HYPR,                           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, xxxxxxx, QK_BOOT,
      xxxxxxx,         xxxxxxx,         xxxxxxx,       xxxxxxx, COS_CMD_CTRL,   xxxxxxx,                           KC_HOME, KC_PGDN, KC_PGUP, KC_END,  xxxxxxx, xxxxxxx,
                                                                          xxxxxxx, xxxxxxx,   _______, xxxxxxx,  xxxxxxx
    ),

    [_NUM] = LAYOUT_reviung41(
      xxxxxxx, KC_HASH, KC_7,    KC_8,    KC_9,    KC_PERCENT,                                  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
      KC_ESC,  xxxxxxx, KC_4,    KC_5,    KC_6,    KC_EQUAL,                                    COS_HYPR, HRM_IDX, HRM_MID, HRM_RNG, HRM_PNK, KC_DOLLAR,
      xxxxxxx, xxxxxxx, KC_1,    KC_2,    KC_3,    xxxxxxx,                                     xxxxxxx, COS_CMD_CTRL,_______,_______,_______, xxxxxxx,
                                                      _______, KC_0,      _______, xxxxxxx, xxxxxxx
    ),
    [_OPT] = LAYOUT_reviung41(
      xxxxxxx, xxxxxxx, xxxxxxx, _______, _______, _______,                                     _______, TG_NIX,  _______, _______, _______, QK_BOOT,
      xxxxxxx,      _______,        _______,        _______, _______, xxxxxxx,                                     _______, _______, _______, _______, _______, xxxxxxx,
      xxxxxxx,      _______,        _______,        _______, _______, _______,                                     _______, _______, _______, _______, _______, xxxxxxx,
                                                                   xxxxxxx, xxxxxxx,   _______, xxxxxxx,  xxxxxxx
    ),
    [_FNKEYS] = LAYOUT_reviung41(
      xxxxxxx, xxxxxxx, KC_F7,   KC_F8,   KC_F9,    KC_F10,                                      KC_F13,  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, QK_BOOT,
